...
public class Constants {
	 ...
	 * app应用名
	 */
	public final static String APPNAME = "ModiMusic";
	/***
	 * ------------------------------------应用基本配置-----------------------------
	 **/
	/**
	...
	public final static String PATH_ALBUM = PATH_TEMP + File.separator
			+ "album";
	public static final String MSG_SEND_CHANGE_BG = "改变背景";
	public static int LRC_DOWNLOAD_STATE = -1;
	public static final int LRC_DOWNLOAD_STATE_FINISH = 1;
	...
	public static int BG_CURRENT_INDEX = new Random().nextInt(PICIDS.length);
	/**
	 * 图片皮肤索引
	 */
	...
	public static boolean isTrafficPhoto = true;
	public static boolean isTrafficLrc = true;
	public static boolean isTrafficOnline = true;
	public static boolean isShowFlowTag = true;
	public static boolean isShowLrc = true;
	public static boolean isShowPlayLrc = true;
	public static boolean isShowDeskLrc = false;
	public static boolean isShowLockLrc = false;
	public static boolean isTryListener = false;
	public static boolean isLongLight = false;
	public static boolean isMemoryExit = true;
	public static boolean isShade = false;
	public static boolean isAutoUpdate = false;
	//菜单控制项状态
	public static String WifiNet = "WIFINET";
	public static String TrafficPhoto = "TRAFFICPHOTO";
	public static String TrafficLrc = "TRAFFICLRC";
	public static String TrafficOnline = "TRAFFICONLINE";
	public static String ShowFlowTag = "SHOWFLOWTAG";
	public static String ShowLrc = "SHOWLRC";
	public static String ShowPlayLrc = "SHOWPLAYLRC";
	public static String ShowDeskLrc = "SHOWDESKLRC";
	public static String ShowLockLrc = "SHOWLOCKLRC";
	public static String TryListener = "TRYLISTENER";
	public static String LongLight = "LONGLIGHT";
	public static String MemoryExit = "MEMORYEXIT";
	public static String Shade = "SHADE";
	public static String AutoUpdate = "AUTOUPDATE";

	//控制浮动标签个数
	public static int MAX_WORLDS = 5;

	public static int LRC_TYPE_LOCAL = 0;
	public static int LRC_TYPE_NET = 1;

	public static String BASE_DIRS_PATH = "/sdcard" + File.separator + APPNAME + File.separator;
	public static String LRC_DIRS_PATH = BASE_DIRS_PATH+"lrc";
	public static String BG_CURRENT_PATH = "default";

	public static String MSG_PLAYA_OVER = "play_over";

	public static String WEB_KEYWORD = "中国新歌声";
	public static String MSG_SONG_LOAD_OVER = "网络歌曲加载完成";

	public static List<Song> WEB_SONG_DATA = new ArrayList<>();
	public static List<Song> LOCAL_SONG_DATA = new ArrayList<>();
	public static List<Song> XML_SONG_DATA = new ArrayList<>();
	public static String HELLO_STATE = "off";
	public static String HELLO_STATE_NO = "no";
	public static String HELLO_STATE_OFF = "off";
	public static String MSG_SEND_SONG_TEXT = "发送文本给桌面歌曲";
	public static int LRC_CURRENT_INDEX = -1;
	public static List<Sentence> LRC_WORD_DATA = new ArrayList<>();
	public static LrcHandle CURRENT_LRC_HANDLER = new LrcHandle();
